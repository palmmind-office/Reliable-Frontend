            ...
            let intervalId = setInterval(() => {
                ...
                if (typeof (text) === 'string') {
                    ...
                    $div.css({
                        ...
                        , "position": "relative",/*'padding': '0 15px',*/ 'background': '#DE1374', "max-width": "46vh", 'color': 'var(--Sent-li-color)', 'font-size': '13px', "border-radius": "10px", "font-family": "'Lato', sans-serif", "animation": "opactyblinkleft",
