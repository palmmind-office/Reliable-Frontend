module.exports = {
  ...
  //ccms keys encryptions
    server_sig_pub: `-----BEGIN PUBLIC KEY-----
    ...
    SOCKET_HOST:'103.1.94.16',
    SOCKET_PORT:9007,
    REDIS_SERVER:'127.0.0.1',
    BASEPATH:'rest/v1',    
    PORT:9007,
    DASHBOARD_SERVER:'54.251.232.54',
    ...
    // #shine receivers
    FEEDBACK_EMAIL:'bohrarajni05@gmail.com',
    //complaint receivers
    CARD_DEPT:'barsarana55@gmail.com',
    MOBILE_BANKING_DEPT:'krisha.tiwari@gmail.com',
    ...
    BOT_TOKEN:'EGqyCHuDwpmiwbWITgQVRWZez34edfAxDSXSmJGLBe5SHPtAv6MhecIaetDci8CJ',
    USERID:'626132ad3aa4471693cbc4fa',
    ADMIN_TOKEN:'NSC1Wr8A1tEcaGt4mTglctQUFRhsUIpgHGUIz73Qwxa9VHk2oro5g0RlLVMHal2T',
    ORGANIZATION_ID:'621f5e498dd8ca0a63bbed56',
    DASHBOARD_PORT:3002,
    MESSANGER_BOT_HOST:'',
